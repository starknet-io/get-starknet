...
This (possibily undefined) value is a [`WalletWithStarknetFeatures`](/core/StarknetWalletRequestFeature) object. This object exposes a list of accounts and the Starknet wallet API.
...
This wallet API has two properties:
 ...
 - `accounts`: an array of `StarknetWalletAccount` objects.
...
The `StarknetWalletAccount` object provides the wallet's address together with additional (optional) properties such as the raw public key and the supported chains.
